...
export const projectData = [
{
    ...
    info:'Tweede poging voor een persoonlijke website. Ik wilde een website maken die makkelijker te onderhouden zou zijn, beter uit te breiden en met een betere UI/UX.',
...
},
{
    ...
    isVideo:true,
    github:'',
    info:'Het doel van het afstudeerproject was om een prototype te maken van een kruispunt in een simulatie met real-time data van objecten zoals auto\'s, verkeerslichten en personen.',
...
},
{
    ...
    info:'Een school project waar het de bedoeling was om een groter probleem op te delen in kleinere stukken om het makkelijker te maken in teamverband te werken.',
    tech:['Python','pygame']
},
{
...
},
{
    ...
    info:'Project voor het bedrijf Label A om te kijken of het mogelijk is Machine Vision te gebruiken voor toegang te verlenen aan een evenement zonder tussenkomst van een medewerker.',
...
},
{
    ...
    info:'Een school project om te werken met mobiele technologie reizigers informatie te geven over verschillende landen op de wereld.',
    tech:['C#','Xamarin']
},
]